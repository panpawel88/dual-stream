...
ffmpeg -f lavfi -i "color=red:size=1280x720:duration=8:rate=30" ^
       -vf "hue=h='360*t/8':s=1,drawbox=x=0:y=0:w=20:h=20:color=yellow:t=fill,drawbox=x=1260:y=0:w=20:h=20:color=green:t=fill,drawbox=x=0:y=700:w=20:h=20:color=blue:t=fill,drawbox=x=1260:y=700:w=20:h=20:color=magenta:t=fill,drawtext=text='Video 3 H265 - Frame %%{frame_num}':fontsize=24:fontcolor=white:x=20:y=20:box=1:boxcolor=black@0.9" ^
...
ffmpeg -f lavfi -i "color=black:size=1280x720:duration=15:rate=30" ^
       -vf "drawbox=x=0:y=0:w=20:h=20:color=yellow:t=fill,drawbox=x=1260:y=0:w=20:h=20:color=green:t=fill,drawbox=x=0:y=700:w=20:h=20:color=blue:t=fill,drawbox=x=1260:y=700:w=20:h=20:color=magenta:t=fill,drawtext=text='DualStream Video Player':fontsize=60:fontcolor=white:x=(w-text_w)/2:y=(h-text_h)/2+50*sin(2*PI*t/3):enable='between(t,0,15)',drawtext=text='Video 5 H265 - Frame %%{frame_num}':fontsize=24:fontcolor=yellow:x=20:y=20:box=1:boxcolor=black@0.8" ^
       -c:v libx265 -preset medium -crf 28 -g 30 -keyint_min 30 -pix_fmt yuv420p ^
       -movflags +faststart ^
...
ffmpeg -f lavfi -i "color=red:size=1280x720:duration=3:rate=60" ^
       -vf "fade=t=in:st=0:d=1,fade=t=out:st=2:d=1,drawbox=x=0:y=0:w=20:h=20:color=yellow:t=fill,drawbox=x=1260:y=0:w=20:h=20:color=green:t=fill,drawbox=x=0:y=700:w=20:h=20:color=blue:t=fill,drawbox=x=1260:y=700:w=20:h=20:color=magenta:t=fill,drawtext=text='SHORT A - Frame %%{frame_num} (60fps)':fontsize=28:fontcolor=white:x=20:y=20:box=1:boxcolor=black@0.9" ^
...
ffmpeg -f lavfi -i "color=blue:size=1280x720:duration=3:rate=60" ^
       -vf "drawbox=x=(w-100*sin(2*PI*t*2))/2:y=(h-100*sin(2*PI*t*2))/2:w=100*sin(2*PI*t*2):h=100*sin(2*PI*t*2):color=white:t=fill,drawbox=x=0:y=0:w=20:h=20:color=yellow:t=fill,drawbox=x=1260:y=0:w=20:h=20:color=green:t=fill,drawbox=x=0:y=700:w=20:h=20:color=blue:t=fill,drawbox=x=1260:y=700:w=20:h=20:color=magenta:t=fill,drawtext=text='SHORT B - Frame %%{frame_num} (60fps)':fontsize=28:fontcolor=cyan:x=20:y=20:box=1:boxcolor=black@0.9" ^
       -c:v libx264 -preset fast -crf 18 -g 30 -keyint_min 30 -pix_fmt yuv420p ^
       -movflags +faststart ^
...
echo Usage examples:
echo ---------------
echo dual_stream.exe test_videos\video1_red_square.mp4 test_videos\video2_blue_circle.mp4
echo dual_stream.exe test_videos\video3_gradient.mp4 test_videos\video4_bouncing_ball.mp4
echo dual_stream.exe test_videos\short_a_red_fade.mp4 test_videos\short_b_blue_pulse.mp4
echo.
echo.
...
echo 60fps HD: dual_stream.exe test_videos\\60fps_video1_red_square.mp4 test_videos\\60fps_video2_blue_circle.mp4
echo 4K 60fps: dual_stream.exe test_videos\\4k_60fps_video1_red_square.mp4 test_videos\\4k_60fps_video2_blue_circle.mp4
echo 8K 60fps: dual_stream.exe test_videos\\8k_60fps_video1_red_square.mp4 test_videos\\8k_60fps_video2_blue_circle.mp4
echo.
